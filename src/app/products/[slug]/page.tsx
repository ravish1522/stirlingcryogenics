...
import { ChevronRight, ArrowRight, CheckCircle2, ImageOff, CheckCircle, FileText, Download } from "lucide-react";

import { PRODUCTS as ALL_PRODUCTS, formatSpecLabel } from "@/data/products";
                    ...
                    <div>
                        <div className="w-full rounded-2xl overflow-hidden mb-7"
                            ...
                            {product.img ? (
                                ...
                                <div className="w-full flex flex-col items-center justify-center gap-2 bg-gray-50 text-gray-300" style={{ height: 320 }}>
                        ...
                        {(product.shortDesc || product.fullDesc) && (
                            <p className="text-gray-600 text-sm leading-relaxed">
                                ...
                                {!expanded && product.fullDesc && product.fullDesc !== product.shortDesc && (
                        ...
                        {product.features.length > 0 && (
                            <div className="mt-6">
                                <h3 className="font-semibold text-gray-800 text-sm mb-3">Key Features</h3>
                                <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid #E5E7EB" }}>
                                    <ul className="divide-y" style={{ borderColor: "#F3F4F6" }}>
                                        {product.features.map((feature) => (
                                            <li key={feature} className="flex items-start gap-2.5 px-5 py-3 text-sm text-gray-700" style={{ borderBottom: "1px solid #F3F4F6" }}>
                        ...
                        {product.applications.length > 0 && (
                            <div className="mt-6">
                                <h3 className="font-semibold text-gray-800 text-sm mb-3">Applications</h3>
                        ...
                        {product.datasheetUrl && (
                            <div className="mt-6">
                                <a href={product.datasheetUrl} target="_blank" rel="noopener noreferrer"
                                   ...
                                   style={{ border: "1px solid #E5E7EB", color: "#00B4D8" }}>
